// Dicionário de palavras-chave -> categoria. Mantido separado do app (que já tem
// as mesmas categorias padrão em src/shared/constants/seed-data.ts) porque este
// script roda em Node, fora do bundle do Angular.
const REGRAS = [
...
export function categorizar(descricao, tipo) {
